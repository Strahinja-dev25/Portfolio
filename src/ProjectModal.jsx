...
// Prihvatamo "projects" listu umesto "category"
function ProjectModal({ projects, onClose }) {
  // Iz prve stavke u listi uzimamo naziv kategorije za naslov
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-projects-grid">
          ...
          {/* MAGIJA: "Mapiramo" (prolazimo kroz) listu projekata */}
          {projects.map((project, index) => (
            // Za svaki projekat u listi, kreiramo jednu karticu
